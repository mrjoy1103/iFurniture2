...
class _MenuPageState extends State<MenuPage> {
  ...
  void initState() {
    super.initState();
    _loadServerAddress();
    _initializeBluetoothManager();  // Initialize BluetoothManager globally
  }
  ...
  Future<void> _initializeBluetoothManager() async {
   ...
   // bluetoothManager.setContext(context);
    ...
    if (serverAddress != null) {
      bluetoothManager.setServerAddress(serverAddress);
      print("Server address set in BluetoothManager: $serverAddress");
    } else {
      print("No server address found in SharedPreferences");
    }
  }
  ...
  Future<void> _loadServerAddress() async {
    ...
    await _initializeBluetoothManager();
  }
              ...
              builder: (context, bluetoothManager, child) {
                return IconButton(
                  icon: Icon(
                    ...
                    color: bluetoothManager.isConnected ? Colors.blue : Colors.grey,
                  ),
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
